...
namespace OpenWifi {
	...
	static ORM::FieldVec ContactDB_Fields{// object info
...
template <>
void ORM::DB<OpenWifi::ContactDBRecordType, OpenWifi::ProvObjects::Contact>::Convert(
	const OpenWifi::ContactDBRecordType &In, OpenWifi::ProvObjects::Contact &Out) {
...
template <>
void ORM::DB<OpenWifi::ContactDBRecordType, OpenWifi::ProvObjects::Contact>::Convert(
	const OpenWifi::ProvObjects::Contact &In, OpenWifi::ContactDBRecordType &Out) {
